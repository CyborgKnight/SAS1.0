...
$query = mysqli_query($conn, "SELECT * FROM masuk") or die('gagal tampil');
?>
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        if (isset($_GET['dari']) && isset($_GET['ke'])) {
                            ...
                            $data = mysqli_query($conn, "SELECT * FROM masuk WHERE tgl_input BETWEEN '" . $_GET['dari'] . "' and '" . $_GET['ke'] . "'");
                        } else {
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['jurusan']; ?></td>
                                <td><?= $row['tgl_input']; ?></td>
                                <td><a href="edit_rekap_kehadiran.php?id=<?= $row["id"]; ?>">Edit</a> | <a href="hapus.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin mau di hapus?')">Hapus</a> </td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
